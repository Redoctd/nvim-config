...
local maps = {
	n = {
		...
		-- Window Navigation
		{ "<leader>pl", cmdWrap("wincmd l"), "Pane Right" },
		{ "<leader>ph", cmdWrap("wincmd h"), "Pane Left" },
		{ "<leader>pk", cmdWrap("wincmd k"), "Pane Up" },
		{ "<leader>pj", cmdWrap("wincmd j"), "Pane Down" },
		...
		{
			"<leader>odb",
			cmdWrap("OverseerRun Build C# Project"),
			"Overseer dotnet build",
		},
		{
			"<leader>oar",
			cmdWrap("OverseerRun RestartAspire"),
			"Overseer dotnet build",
		},
